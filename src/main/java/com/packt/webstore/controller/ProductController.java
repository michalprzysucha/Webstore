...
//    metoda, ktora dziala dokladnie jak ta wyzej
    ...
    public String processAddNewProductForm(@ModelAttribute("newProduct") @Valid Product productToBeAdded,
        ...
        if (productImage != null && !productImage.isEmpty()) {
            try{
                Files.createDirectories(Paths.get(rootDirectory, "resources", "images"));
                Files.createDirectories(Paths.get(rootDirectory, "resources", "pdf"));
                productImage.transferTo(new File(rootDirectory +
                        "resources\\images\\" + productToBeAdded.getProductId() + ".png"));
                manual.transferTo(new File(rootDirectory +
                        "resources\\pdf\\" + productToBeAdded.getProductId() + ".pdf"));
            } catch (IOException e) {
